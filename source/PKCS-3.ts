...
export class DHParameter {
    constructor (
        ...
        readonly privateValueLength: asn1.INTEGER | undefined
    ) {}
}
export const _root_component_type_list_1_spec_for_DHParameter: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("base", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("privateValueLength", true, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined)
];
...
export const _decode_DHParameter = function (el: asn1.ASN1Element): DHParameter {
    ...
    const callbacks: __utils.DecodingMap = {
        "prime": (_el: asn1.ASN1Element): void => { prime = __utils._decodeInteger(_el); },
        "base": (_el: asn1.ASN1Element): void => { base = __utils._decodeInteger(_el); },
        "privateValueLength": (_el: asn1.ASN1Element): void => { privateValueLength = __utils._decodeInteger(_el); }
    };
...
export const _encode_DHParameter = function (value: DHParameter, elGetter: __utils.ASN1Encoder<DHParameter>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ __utils._encodeInteger(value.base, __utils.BER),
            /* IF_ABSENT  */ ((value.privateValueLength === undefined) ? undefined : __utils._encodeInteger(value.privateValueLength, __utils.BER))
        ],
