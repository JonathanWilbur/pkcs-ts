...
export const attributeSyntax: ID = new asn1.ObjectIdentifier([5], ds);
...
export const dap: ID = new asn1.ObjectIdentifier([/* dap */ 11, 3], module_);

export const dsp: ID = new asn1.ObjectIdentifier([/* dsp */ 12, 3], module_);

export const distributedDirectoryOIDs: ID = new asn1.ObjectIdentifier(
    [/* distributedDirectoryOIDs */ 13, 3],
    module_
);

export const directoryShadowOIDs: ID = new asn1.ObjectIdentifier(
    [/* directoryShadowOIDs */ 14, 3],
    module_
);
...
export const disp: ID = new asn1.ObjectIdentifier([/* disp */ 16, 3], module_);

export const dop: ID = new asn1.ObjectIdentifier([/* dop */ 17, 3], module_);
...
export const rosObject: ID = new asn1.ObjectIdentifier([25], ds);

export const id_rosObject: ID = rosObject;

export const contract: ID = new asn1.ObjectIdentifier([26], ds);

export const id_contract: ID = contract;

export const package_: ID = new asn1.ObjectIdentifier([27], ds);
