...
export const _extension_additions_list_spec_for_OneAsymmetricKey: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("publicKey", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), 0, 2)
];

export const _decode_OneAsymmetricKey = function (el: asn1.ASN1Element): OneAsymmetricKey {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "privateKeyAlgorithm": (_el: asn1.ASN1Element): void => { privateKeyAlgorithm = _decode_PrivateKeyAlgorithmIdentifier(_el); },
        "privateKey": (_el: asn1.ASN1Element): void => { privateKey = _decode_PrivateKey(_el); },
        "attributes": (_el: asn1.ASN1Element): void => { attributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(_el); },
        "publicKey": (_el: asn1.ASN1Element): void => { publicKey = __utils._decode_implicit<PublicKey>(() => _decode_PublicKey)(_el); }
    };
...
export const _encode_OneAsymmetricKey = function (value: OneAsymmetricKey, elGetter: __utils.ASN1Encoder<OneAsymmetricKey>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_PrivateKeyAlgorithmIdentifier(value.privateKeyAlgorithm, __utils.BER),
            /* REQUIRED   */ _encode_PrivateKey(value.privateKey, __utils.BER),
        ...
        [
            /* IF_ABSENT  */ ((value.publicKey === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_PublicKey, __utils.BER)(value.publicKey, __utils.BER))
        ],
...
export const _decode_AsymmetricKeyPackage = __utils._decodeSequenceOf<OneAsymmetricKey>(() => _decode_OneAsymmetricKey);
export const _encode_AsymmetricKeyPackage = __utils._encodeSequenceOf<OneAsymmetricKey>(() => _encode_OneAsymmetricKey, __utils.BER);
...
export const _root_component_type_list_1_spec_for_EncryptedPrivateKeyInfo: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("encryptionAlgorithm", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("encryptedData", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined)
];
...
export const _decode_EncryptedPrivateKeyInfo = function (el: asn1.ASN1Element): EncryptedPrivateKeyInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("EncryptedPrivateKeyInfo contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_EncryptedPrivateKeyInfo = function (value: EncryptedPrivateKeyInfo, elGetter: __utils.ASN1Encoder<EncryptedPrivateKeyInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_EncryptionAlgorithmIdentifier(value.encryptionAlgorithm, __utils.BER),
            /* REQUIRED   */ _encode_EncryptedData(value.encryptedData, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
