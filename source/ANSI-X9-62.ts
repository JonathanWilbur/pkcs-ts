...
export const _root_component_type_list_1_spec_for_Characteristic_two: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("m", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("basis", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
...
export const _decode_Characteristic_two = function (el: asn1.ASN1Element): Characteristic_two {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("Characteristic-two contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "m";
...
export const _encode_Characteristic_two = function (value: Characteristic_two, elGetter: __utils.ASN1Encoder<Characteristic_two>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeInteger(value.m, __utils.BER),
            /* REQUIRED   */ __utils._encodeObjectIdentifier(value.basis, __utils.BER),
...
export const _root_component_type_list_1_spec_for_Pentanomial: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("k1", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("k2", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("k3", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined)
];
...
export const _decode_Pentanomial = function (el: asn1.ASN1Element): Pentanomial {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new asn1.ASN1ConstructionError("Pentanomial contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "k1";
    sequence[1].name = "k2";
...
export const _encode_Pentanomial = function (value: Pentanomial, elGetter: __utils.ASN1Encoder<Pentanomial>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_ECDSA_Sig_Value = function (el: asn1.ASN1Element): ECDSA_Sig_Value {
    const sequence: asn1.ASN1Element[] = el.sequence;
...
export const _encode_ECDSA_Sig_Value = function (value: ECDSA_Sig_Value, elGetter: __utils.ASN1Encoder<ECDSA_Sig_Value>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_Algorithmldentifier = function (el: asn1.ASN1Element): Algorithmldentifier {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("Algorithmldentifier contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
...
export const _encode_Algorithmldentifier = function (value: Algorithmldentifier, elGetter: __utils.ASN1Encoder<Algorithmldentifier>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_SubjectPublicKeylnfo = function (el: asn1.ASN1Element): SubjectPublicKeylnfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("SubjectPublicKeylnfo contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "algorithm";
...
export const _encode_SubjectPublicKeylnfo = function (value: SubjectPublicKeylnfo, elGetter: __utils.ASN1Encoder<SubjectPublicKeylnfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Algorithmldentifier(value.algorithm, __utils.BER),
...
export const _root_component_type_list_1_spec_for_Curve: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("a", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("b", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("seed", true, __utils.hasTag(asn1.ASN1TagClass.universal, 3), undefined, undefined)
];
...
export const _decode_Curve = function (el: asn1.ASN1Element): Curve {
    ...
    const callbacks: __utils.DecodingMap = {
        "a": (_el: asn1.ASN1Element): void => { a = _decode_FieldElement(_el); },
        "b": (_el: asn1.ASN1Element): void => { b = _decode_FieldElement(_el); },
        "seed": (_el: asn1.ASN1Element): void => { seed = __utils._decodeBitString(_el); }
    };
...
export const _encode_Curve = function (value: Curve, elGetter: __utils.ASN1Encoder<Curve>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_FieldElement(value.a, __utils.BER),
            /* REQUIRED   */ _encode_FieldElement(value.b, __utils.BER),
            /* IF_ABSENT  */ ((value.seed === undefined) ? undefined : __utils._encodeBitString(value.seed, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_ECParameters: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("fieldID", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("curve", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("base", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("order", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
...
export const _decode_ECParameters = function (el: asn1.ASN1Element): ECParameters {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_ECParameters_version(_el); },
        "fieldID": (_el: asn1.ASN1Element): void => { fieldID = _decode_FieldID(_el); },
        "curve": (_el: asn1.ASN1Element): void => { curve = _decode_Curve(_el); },
        "base": (_el: asn1.ASN1Element): void => { base = _decode_ECPoint(_el); },
        "order": (_el: asn1.ASN1Element): void => { order = __utils._decodeInteger(_el); },
        "cofactor": (_el: asn1.ASN1Element): void => { cofactor = _decode_NTEGER(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ECParameters = function (value: ECParameters, elGetter: __utils.ASN1Encoder<ECParameters>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ECParameters_version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_FieldID(value.fieldID, __utils.BER),
            /* REQUIRED   */ _encode_Curve(value.curve, __utils.BER),
            /* REQUIRED   */ _encode_ECPoint(value.base, __utils.BER),
            /* REQUIRED   */ __utils._encodeInteger(value.order, __utils.BER),
            /* IF_ABSENT  */ ((value.cofactor === undefined) ? undefined : _encode_NTEGER(value.cofactor, __utils.BER))
        ],
...
export const _decode_Parameters = __utils._decode_inextensible_choice<Parameters>({
