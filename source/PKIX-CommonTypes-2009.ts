...
export const _decode_AttributeSet = function (
    el: asn1.ASN1Element
): AttributeSet {
...
export const _encode_AttributeSet = function (
    value: AttributeSet,
...
export const _decode_SingleAttribute = function (
    el: asn1.ASN1Element
): SingleAttribute {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
...
export const _encode_SingleAttribute = function (
