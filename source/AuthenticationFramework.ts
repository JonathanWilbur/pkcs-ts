...
export const _root_component_type_list_1_spec_for_SIGNATURE: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("encrypted", false, __utils.hasTag(asn1.ASN1TagClass.universal, 3), undefined, undefined)
];
...
export const _get_decoder_for_SIGNATURE = function <ToBeSigned>(_decode_ToBeSigned: __utils.ASN1Decoder<ToBeSigned>) {
return function <ToBeSigned>(el: asn1.ASN1Element): SIGNATURE<ToBeSigned> {
    ...
    encrypted = _get_decoder_for_ENCRYPTED_HASH<ToBeSigned>(_decode_ToBeSigned)(sequence[1]);
    // TODO: Validate values.
    return new SIGNATURE<ToBeSigned>(
        algorithmIdentifier,
        encrypted,
...
export const _get_encoder_for_SIGNATURE = function <ToBeSigned>(_encode_ToBeSigned: __utils.ASN1Encoder<ToBeSigned>) {
return function (value: SIGNATURE<ToBeSigned>, elGetter: __utils.ASN1Encoder<SIGNATURE<ToBeSigned>>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.algorithmIdentifier, __utils.BER),
            /* REQUIRED   */ _get_encoder_for_ENCRYPTED_HASH<ToBeSigned>(_encode_ToBeSigned)(value.encrypted, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}
}
...
export class SIGNED<ToBeSigned> {
    constructor (
        ...
        readonly encrypted: ENCRYPTED_HASH<ToBeSigned> /* REPLICATED_COMPONENT */
    ) {}
}
...
return function (el: asn1.ASN1Element): SIGNED<ToBeSigned> {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "encrypted": (_el: asn1.ASN1Element): void => { encrypted = _get_decoder_for_ENCRYPTED_HASH<ToBeSigned>(_decode_ToBeSigned)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export type Certificate = SIGNED<{ version: Version; serialNumber: asn1.OPTIONAL<CertificateSerialNumber>; signature: asn1.OPTIONAL<AlgorithmIdentifier>; issuer: asn1.OPTIONAL<Name>; validity: asn1.OPTIONAL<Validity>; subject: asn1.OPTIONAL<Name>; subjectPublicKeyInfo: asn1.OPTIONAL<SubjectPublicKeyInfo>; issuerUniqueIdentifier: UniqueIdentifier; subjectUniqueIdentifier: UniqueIdentifier; extensions: Extensions }>; // DefinedType
export const _decode_Certificate = _get_decoder_for_SIGNED<{ version: Version; serialNumber: asn1.OPTIONAL<CertificateSerialNumber>; signature: asn1.OPTIONAL<AlgorithmIdentifier>; issuer: asn1.OPTIONAL<Name>; validity: asn1.OPTIONAL<Validity>; subject: asn1.OPTIONAL<Name>; subjectPublicKeyInfo: asn1.OPTIONAL<SubjectPublicKeyInfo>; issuerUniqueIdentifier: UniqueIdentifier; subjectUniqueIdentifier: UniqueIdentifier; extensions: Extensions }>(function (el: asn1.ASN1Element): SIGNED {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export const _encode_Certificate = _get_encoder_for_SIGNED<{ version: Version; serialNumber: asn1.OPTIONAL<CertificateSerialNumber>; signature: asn1.OPTIONAL<AlgorithmIdentifier>; issuer: asn1.OPTIONAL<Name>; validity: asn1.OPTIONAL<Validity>; subject: asn1.OPTIONAL<Name>; subjectPublicKeyInfo: asn1.OPTIONAL<SubjectPublicKeyInfo>; issuerUniqueIdentifier: UniqueIdentifier; subjectUniqueIdentifier: UniqueIdentifier; extensions: Extensions }>(function (value: SIGNED, elGetter: __utils.ASN1Encoder<SIGNED>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_DEFAULT */ (value.version === undefined || __utils.deepEq(value.version, _default_value_for_SIGNED__version) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_Version, __utils.BER)(value.version, __utils.BER)),
            ...
            /* IF_ABSENT  */ ((value.issuerUniqueIdentifier === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_UniqueIdentifier, __utils.BER)(value.issuerUniqueIdentifier, __utils.BER)),
            /* IF_ABSENT  */ ((value.subjectUniqueIdentifier === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => _encode_UniqueIdentifier, __utils.BER)(value.subjectUniqueIdentifier, __utils.BER)),
...
export const _encode_Certificates = function (value: Certificates, elGetter: __utils.ASN1Encoder<Certificates>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Certificate(value.userCertificate, __utils.BER),
            /* IF_ABSENT  */ ((value.certificationPath === undefined) ? undefined : _encode_ForwardCertificationPath(value.certificationPath, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_CertificatePair: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("issuedByThisCA", true, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined),
    new __utils.ComponentSpec("issuedToThisCA", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), undefined, undefined)
];
...
export const _encode_CertificatePair = function (value: CertificatePair, elGetter: __utils.ASN1Encoder<CertificatePair>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.issuedByThisCA === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_Certificate, __utils.BER)(value.issuedByThisCA, __utils.BER)),
            /* IF_ABSENT  */ ((value.issuedToThisCA === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_Certificate, __utils.BER)(value.issuedToThisCA, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_CertificationPath = function (value: CertificationPath, elGetter: __utils.ASN1Encoder<CertificationPath>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Certificate(value.userCertificate, __utils.BER),
            /* IF_ABSENT  */ ((value.theCACertificates === undefined) ? undefined : __utils._encodeSequenceOf<CertificatePair>(() => _encode_CertificatePair, __utils.BER)(value.theCACertificates, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};


export type CertificateList = SIGNED<{ version: Version; signature: asn1.OPTIONAL<AlgorithmIdentifier>; issuer: asn1.OPTIONAL<Name>; thisUpdate: asn1.OPTIONAL<Time>; nextUpdate: Time; revokedCertificates: { userCertificate: asn1.OPTIONAL<CertificateSerialNumber>; revocationDate: asn1.OPTIONAL<Time>; crlEntryExtensions: Extensions }[]; crlExtensions: Extensions }>; // DefinedType
export const _decode_CertificateList = _get_decoder_for_SIGNED<{ version: Version; signature: asn1.OPTIONAL<AlgorithmIdentifier>; issuer: asn1.OPTIONAL<Name>; thisUpdate: asn1.OPTIONAL<Time>; nextUpdate: Time; revokedCertificates: { userCertificate: asn1.OPTIONAL<CertificateSerialNumber>; revocationDate: asn1.OPTIONAL<Time>; crlEntryExtensions: Extensions }[]; crlExtensions: Extensions }>(function (el: asn1.ASN1Element): SIGNED {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    ...
    let revokedCertificates: asn1.OPTIONAL<{ userCertificate: asn1.OPTIONAL<CertificateSerialNumber>; revocationDate: asn1.OPTIONAL<Time>; crlEntryExtensions: Extensions }[]>;
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "revokedCertificates": (_el: asn1.ASN1Element): void => { revokedCertificates = __utils._decodeSequenceOf<{ userCertificate: asn1.OPTIONAL<CertificateSerialNumber>; revocationDate: asn1.OPTIONAL<Time>; crlEntryExtensions: Extensions }>(() => function (el: asn1.ASN1Element): revokedCertificates {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export const _encode_CertificateList = _get_encoder_for_SIGNED<{ version: Version; signature: asn1.OPTIONAL<AlgorithmIdentifier>; issuer: asn1.OPTIONAL<Name>; thisUpdate: asn1.OPTIONAL<Time>; nextUpdate: Time; revokedCertificates: { userCertificate: asn1.OPTIONAL<CertificateSerialNumber>; revocationDate: asn1.OPTIONAL<Time>; crlEntryExtensions: Extensions }[]; crlExtensions: Extensions }>(function (value: SIGNED, elGetter: __utils.ASN1Encoder<SIGNED>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* FIXME: revokedCertificates COULD_NOT_COMPILE_TYPE_ENCODER */,
...
export const _decode_AttributeCertificateInfo_subject = __utils._decode_inextensible_choice<AttributeCertificateInfo_subject>({
    "CONTEXT 0": [ "baseCertificateID", __utils._decode_explicit<IssuerSerial>(() => _decode_IssuerSerial) ],
    "CONTEXT 1": [ "subjectName", __utils._decode_explicit<GeneralNames>(() => _decode_GeneralNames) ]
});
export const _encode_AttributeCertificateInfo_subject = __utils._encode_choice<AttributeCertificateInfo_subject>({
    "baseCertificateID": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_IssuerSerial, __utils.BER),
    "subjectName": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_GeneralNames, __utils.BER),
}, __utils.BER);
...
export const _root_component_type_list_1_spec_for_AttributeCertificateInfo: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("attCertValidityPeriod", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
...
export const _decode_AttributeCertificateInfo = function (el: asn1.ASN1Element): AttributeCertificateInfo {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_Version(_el); },
        "subject": (_el: asn1.ASN1Element): void => { subject = _decode_AttributeCertificateInfo_subject(_el); },
        "issuer": (_el: asn1.ASN1Element): void => { issuer = _decode_GeneralNames(_el); },
        "signature": (_el: asn1.ASN1Element): void => { signature = _decode_AlgorithmIdentifier(_el); },
        "serialNumber": (_el: asn1.ASN1Element): void => { serialNumber = _decode_CertificateSerialNumber(_el); },
        "attCertValidityPeriod": (_el: asn1.ASN1Element): void => { attCertValidityPeriod = _decode_AttCertValidityPeriod(_el); },
...
export const _encode_AttributeCertificateInfo = function (value: AttributeCertificateInfo, elGetter: __utils.ASN1Encoder<AttributeCertificateInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_DEFAULT */ (value.version === undefined || __utils.deepEq(value.version, _default_value_for_AttributeCertificateInfo__version) ? undefined : _encode_Version(value.version, __utils.BER)),
            /* REQUIRED   */ _encode_AttributeCertificateInfo_subject(value.subject, __utils.BER),
            /* REQUIRED   */ _encode_GeneralNames(value.issuer, __utils.BER),
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.signature, __utils.BER),
            /* REQUIRED   */ _encode_CertificateSerialNumber(value.serialNumber, __utils.BER),
            /* REQUIRED   */ _encode_AttCertValidityPeriod(value.attCertValidityPeriod, __utils.BER),
            /* REQUIRED   */ __utils._encodeSequenceOf<Attribute>(() => _encode_Attribute, __utils.BER)(value.attributes, __utils.BER),
...
export const _decode_AttributeCertificate = _get_decoder_for_SIGNED<AttributeCertificateInfo>(_decode_AttributeCertificateInfo);
export const _encode_AttributeCertificate = _get_encoder_for_SIGNED<AttributeCertificateInfo>(_encode_AttributeCertificateInfo);
...
export const _decode_ACPathData = function (el: asn1.ASN1Element): ACPathData {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "certificate": (_el: asn1.ASN1Element): void => { certificate = __utils._decode_explicit<Certificate>(() => _decode_Certificate)(_el); },
        "attributeCertificate": (_el: asn1.ASN1Element): void => { attributeCertificate = __utils._decode_explicit<AttributeCertificate>(() => _decode_AttributeCertificate)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_ACPathData = function (value: ACPathData, elGetter: __utils.ASN1Encoder<ACPathData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.certificate === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_Certificate, __utils.BER)(value.certificate, __utils.BER)),
            /* IF_ABSENT  */ ((value.attributeCertificate === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_AttributeCertificate, __utils.BER)(value.attributeCertificate, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _encode_AttributeCertificationPath = function (value: AttributeCertificationPath, elGetter: __utils.ASN1Encoder<AttributeCertificationPath>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AttributeCertificate(value.attributeCertificate, __utils.BER),
            /* IF_ABSENT  */ ((value.acPath === undefined) ? undefined : __utils._encodeSequenceOf<ACPathData>(() => _encode_ACPathData, __utils.BER)(value.acPath, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export type AttributeCertificateAssertion_subject =
    { baseCertificateID: IssuerSerial }
    | { subjectName: Name };
export const _decode_AttributeCertificateAssertion_subject = __utils._decode_inextensible_choice<AttributeCertificateAssertion_subject>({
    "CONTEXT 0": [ "baseCertificateID", __utils._decode_explicit<IssuerSerial>(() => _decode_IssuerSerial) ],
    "CONTEXT 1": [ "subjectName", __utils._decode_explicit<Name>(() => _decode_Name) ]
});
export const _encode_AttributeCertificateAssertion_subject = __utils._encode_choice<AttributeCertificateAssertion_subject>({
    "baseCertificateID": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_IssuerSerial, __utils.BER),
    "subjectName": __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_Name, __utils.BER),
}, __utils.BER);
...
export const _root_component_type_list_1_spec_for_AttributeCertificateAssertion: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("subject", true, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined),
...
export const _decode_AttributeCertificateAssertion = function (el: asn1.ASN1Element): AttributeCertificateAssertion {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "subject": (_el: asn1.ASN1Element): void => { subject = __utils._decode_explicit<AttributeCertificateAssertion_subject>(() => _decode_AttributeCertificateAssertion_subject)(_el); },
        "issuer": (_el: asn1.ASN1Element): void => { issuer = __utils._decode_explicit<Name>(() => _decode_Name)(_el); },
        "attCertValidity": (_el: asn1.ASN1Element): void => { attCertValidity = __utils._decode_explicit<asn1.GeneralizedTime>(() => __utils._decodeGeneralizedTime)(_el); },
        "attType": (_el: asn1.ASN1Element): void => { attType = __utils._decode_explicit<AttributeType[]>(() => __utils._decodeSetOf<AttributeType>(() => _decode_AttributeType))(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_AttributeCertificateAssertion = function (value: AttributeCertificateAssertion, elGetter: __utils.ASN1Encoder<AttributeCertificateAssertion>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.subject === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_AttributeCertificateAssertion_subject, __utils.BER)(value.subject, __utils.BER)),
            /* IF_ABSENT  */ ((value.issuer === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => _encode_Name, __utils.BER)(value.issuer, __utils.BER)),
            /* IF_ABSENT  */ ((value.attCertValidity === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 2, () => __utils._encodeGeneralizedTime, __utils.BER)(value.attCertValidity, __utils.BER)),
            /* IF_ABSENT  */ ((value.attType === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 3, () => __utils._encodeSetOf<AttributeType>(() => _encode_AttributeType, __utils.BER), __utils.BER)(value.attType, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
return function (value: HASH<ToBeHashed>, elGetter: __utils.ASN1Encoder<HASH<ToBeHashed>>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.algorithmIdentifier, __utils.BER),
            /* REQUIRED   */ __utils._encodeBitString(value.hashValue, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}
}
