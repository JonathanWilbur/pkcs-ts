...
export const _encode_ExtendedCertificateInfo = function (value: ExtendedCertificateInfo, elGetter: __utils.ASN1Encoder<ExtendedCertificateInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_Attributes(value.attributes, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_ExtendedCertificate = _get_decoder_for_SIGNED<ExtendedCertificateInfo>(_decode_ExtendedCertificateInfo);
export const _encode_ExtendedCertificate = _get_encoder_for_SIGNED<ExtendedCertificateInfo>(_encode_ExtendedCertificateInfo);
...
export const _decode_CertificateChoice = __utils._decode_inextensible_choice<CertificateChoice>({
    ...
    "CONTEXT 1": [ "attributeCertificate", __utils._decode_implicit<AttributeCertificate>(() => _decode_AttributeCertificate) ]
});
export const _encode_CertificateChoice = __utils._encode_choice<CertificateChoice>({
    ...
    "attributeCertificate": __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_AttributeCertificate, __utils.BER),
}, __utils.BER);


export type CertificateSet = CertificateChoice[]; // SetOfType
export const _decode_CertificateSet = __utils._decodeSetOf<CertificateChoice>(() => _decode_CertificateChoice);
export const _encode_CertificateSet = __utils._encodeSetOf<CertificateChoice>(() => _encode_CertificateChoice, __utils.BER);
...
export const _decode_SignerIdentifier = __utils._decode_inextensible_choice<SignerIdentifier>({
    ...
    "CONTEXT 2": [ "subjectKeyIdentifier", __utils._decode_implicit<SubjectKeyIdentifier>(() => _decode_SubjectKeyIdentifier) ]
});
export const _encode_SignerIdentifier = __utils._encode_choice<SignerIdentifier>({
    ...
    "subjectKeyIdentifier": __utils._encode_implicit(asn1.ASN1TagClass.context, 2, () => _encode_SubjectKeyIdentifier, __utils.BER),
}, __utils.BER);
...
export type Digest = HASH<{ content: asn1.ASN1Element } | { authenticated_attributes: Attributes }>; // DefinedType
export const _decode_Digest = _get_decoder_for_HASH<{ content: asn1.ASN1Element } | { authenticated_attributes: Attributes }>(__utils._decode_inextensible_choice<HASH>({
    "CONTEXT 1": [ "content", __utils._decode_implicit<asn1.ASN1Element>(() => __utils._decodeAny) ],
    "CONTEXT 0": [ "authenticated_attributes", __utils._decode_explicit<Attributes>(() => _decode_Attributes) ]
}));
export const _encode_Digest = _get_encoder_for_HASH<{ content: asn1.ASN1Element } | { authenticated_attributes: Attributes }>(__utils._encode_choice<HASH>({
    "content": __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeAny, __utils.BER),
    "authenticated_attributes": __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => _encode_Attributes, __utils.BER),
}, __utils.BER));
...
export const _decode_EncryptedDigest = _get_decoder_for_ENCRYPTED<DigestInfo>(_decode_DigestInfo);
export const _encode_EncryptedDigest = _get_encoder_for_ENCRYPTED<DigestInfo>(_encode_DigestInfo);
...
export const _root_component_type_list_1_spec_for_SignerInfo: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("version", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("signerIdentifier", false, __utils.hasAnyTag, undefined, undefined),
    new __utils.ComponentSpec("digestAlgorithm", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("authenticatedAttributes", true, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined),
    new __utils.ComponentSpec("digestEncryptionAlgorithm", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("encryptedDigest", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("unauthenticatedAttributes", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), undefined, undefined)
];
...
export const _decode_SignerInfo = function (el: asn1.ASN1Element): SignerInfo {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "signerIdentifier": (_el: asn1.ASN1Element): void => { signerIdentifier = _decode_SignerIdentifier(_el); },
        "digestAlgorithm": (_el: asn1.ASN1Element): void => { digestAlgorithm = _decode_DigestAlgorithmIdentifier(_el); },
        "authenticatedAttributes": (_el: asn1.ASN1Element): void => { authenticatedAttributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(_el); },
        "digestEncryptionAlgorithm": (_el: asn1.ASN1Element): void => { digestEncryptionAlgorithm = _decode_DigestEncryptionAlgorithmIdentifier(_el); },
        "encryptedDigest": (_el: asn1.ASN1Element): void => { encryptedDigest = _decode_EncryptedDigest(_el); },
        "unauthenticatedAttributes": (_el: asn1.ASN1Element): void => { unauthenticatedAttributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(_el); }
    };
...
export const _encode_SignerInfo = function (value: SignerInfo, elGetter: __utils.ASN1Encoder<SignerInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_SignerIdentifier(value.signerIdentifier, __utils.BER),
            /* REQUIRED   */ _encode_DigestAlgorithmIdentifier(value.digestAlgorithm, __utils.BER),
            /* IF_ABSENT  */ ((value.authenticatedAttributes === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_Attributes, __utils.BER)(value.authenticatedAttributes, __utils.BER)),
            /* REQUIRED   */ _encode_DigestEncryptionAlgorithmIdentifier(value.digestEncryptionAlgorithm, __utils.BER),
            /* REQUIRED   */ _encode_EncryptedDigest(value.encryptedDigest, __utils.BER),
            /* IF_ABSENT  */ ((value.unauthenticatedAttributes === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_Attributes, __utils.BER)(value.unauthenticatedAttributes, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_SignedData: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("contentInfo", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
...
export const _decode_SignedData = function (el: asn1.ASN1Element): SignedData {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "contentInfo": (_el: asn1.ASN1Element): void => { contentInfo = _decode_ContentInfo(_el); },
...
export const _encode_SignedData = function (value: SignedData, elGetter: __utils.ASN1Encoder<SignedData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_ContentInfo(value.contentInfo, __utils.BER),
...
export const _root_component_type_list_1_spec_for_KeyTransportRecipientInfo: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("version", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("recipientIdentifier", false, __utils.hasAnyTag, undefined, undefined),
...
export const _decode_KeyTransportRecipientInfo = function (el: asn1.ASN1Element): KeyTransportRecipientInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new asn1.ASN1ConstructionError("KeyTransportRecipientInfo contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "version";
...
export const _encode_KeyTransportRecipientInfo = function (value: KeyTransportRecipientInfo, elGetter: __utils.ASN1Encoder<KeyTransportRecipientInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_RecipientIdentifier(value.recipientIdentifier, __utils.BER),
...
export const _decode_OriginatorIdentifierOrKey = __utils._decode_inextensible_choice<OriginatorIdentifierOrKey>({
    "UNIVERSAL 16": [ "issuerAndSerialNumber", _decode_IssuerAndSerialNumber ],
    "CONTEXT 0": [ "subjectKeyIdentifier", __utils._decode_implicit<SubjectKeyIdentifier>(() => _decode_SubjectKeyIdentifier) ],
    "CONTEXT 1": [ "originatorPublicKey", __utils._decode_implicit<OriginatorPublicKey>(() => _decode_OriginatorPublicKey) ]
});
export const _encode_OriginatorIdentifierOrKey = __utils._encode_choice<OriginatorIdentifierOrKey>({
    "issuerAndSerialNumber": _encode_IssuerAndSerialNumber,
    "subjectKeyIdentifier": __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_SubjectKeyIdentifier, __utils.BER),
    "originatorPublicKey": __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_OriginatorPublicKey, __utils.BER),
}, __utils.BER);
...
export const _root_component_type_list_1_spec_for_RecipientKeyIdentifier: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("otherKeyAttribute", true, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined)
];
...
export const _decode_RecipientKeyIdentifier = function (el: asn1.ASN1Element): RecipientKeyIdentifier {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "otherKeyAttribute": (_el: asn1.ASN1Element): void => { otherKeyAttribute = _decode_OtherKeyAttribute(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_RecipientKeyIdentifier = function (value: RecipientKeyIdentifier, elGetter: __utils.ASN1Encoder<RecipientKeyIdentifier>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.otherKeyAttribute === undefined) ? undefined : _encode_OtherKeyAttribute(value.otherKeyAttribute, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_KeyAgreementRecipientIdentifier = __utils._decode_inextensible_choice<KeyAgreementRecipientIdentifier>({
    "UNIVERSAL 16": [ "issuerAndSerialNumber", _decode_IssuerAndSerialNumber ],
    "CONTEXT 0": [ "recipientKeyIdentifier", __utils._decode_implicit<RecipientKeyIdentifier>(() => _decode_RecipientKeyIdentifier) ]
});
export const _encode_KeyAgreementRecipientIdentifier = __utils._encode_choice<KeyAgreementRecipientIdentifier>({
    "issuerAndSerialNumber": _encode_IssuerAndSerialNumber,
    "recipientKeyIdentifier": __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_RecipientKeyIdentifier, __utils.BER),
}, __utils.BER);
...
export const _encode_RecipientEncryptedKey = function (value: RecipientEncryptedKey, elGetter: __utils.ASN1Encoder<RecipientEncryptedKey>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_KeyAgreementRecipientIdentifier(value.recipientIdentifier, __utils.BER),
            /* REQUIRED   */ _encode_EncryptedKey(value.encryptedKey, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_KeyAgreementRecipientInfo: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("userKeyingMaterial", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), undefined, undefined),
    new __utils.ComponentSpec("keyEncryptionAlgorithm", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
...
export const _decode_KeyAgreementRecipientInfo = function (el: asn1.ASN1Element): KeyAgreementRecipientInfo {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let version!: Version;
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_Version(_el); },
        "originator": (_el: asn1.ASN1Element): void => { originator = __utils._decode_implicit<OriginatorIdentifierOrKey>(() => _decode_OriginatorIdentifierOrKey)(_el); },
        "userKeyingMaterial": (_el: asn1.ASN1Element): void => { userKeyingMaterial = __utils._decode_explicit<asn1.OCTET_STRING>(() => __utils._decodeOctetString)(_el); },
...
export const _encode_KeyAgreementRecipientInfo = function (value: KeyAgreementRecipientInfo, elGetter: __utils.ASN1Encoder<KeyAgreementRecipientInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Version(value.version, __utils.BER),
            /* REQUIRED   */ __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_OriginatorIdentifierOrKey, __utils.BER)(value.originator, __utils.BER),
            /* IF_ABSENT  */ ((value.userKeyingMaterial === undefined) ? undefined : __utils._encode_explicit(asn1.ASN1TagClass.context, 1, () => __utils._encodeOctetString, __utils.BER)(value.userKeyingMaterial, __utils.BER)),
            /* REQUIRED   */ _encode_KeyEncryptionAlgorithmIdentifier(value.keyEncryptionAlgorithm, __utils.BER),
...
export const _decode_KeyEncryptionKeyIdentifier = function (el: asn1.ASN1Element): KeyEncryptionKeyIdentifier {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export const _encode_KeyEncryptionKeyIdentifier = function (value: KeyEncryptionKeyIdentifier, elGetter: __utils.ASN1Encoder<KeyEncryptionKeyIdentifier>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _root_component_type_list_1_spec_for_KeyEncryptionKeyRecipientInfo: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("version", false, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined),
    new __utils.ComponentSpec("keyEncryptionKeyIdentifier", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("keyEncryptionAlgorithm", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("encryptedKey", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined)
];
...
export const _decode_KeyEncryptionKeyRecipientInfo = function (el: asn1.ASN1Element): KeyEncryptionKeyRecipientInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new asn1.ASN1ConstructionError("KeyEncryptionKeyRecipientInfo contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    sequence[0].name = "version";
...
export const _encode_KeyEncryptionKeyRecipientInfo = function (value: KeyEncryptionKeyRecipientInfo, elGetter: __utils.ASN1Encoder<KeyEncryptionKeyRecipientInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_KeyEncryptionKeyIdentifier(value.keyEncryptionKeyIdentifier, __utils.BER),
            /* REQUIRED   */ _encode_KeyEncryptionAlgorithmIdentifier(value.keyEncryptionAlgorithm, __utils.BER),
            /* REQUIRED   */ _encode_EncryptedKey(value.encryptedKey, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
...
export const _decode_RecipientInfo = __utils._decode_inextensible_choice<RecipientInfo>({
    "UNIVERSAL 16": [ "keyTransportRecipientInfo", _decode_KeyTransportRecipientInfo ],
    "CONTEXT 1": [ "keyAgreementRecipientInfo", __utils._decode_implicit<KeyAgreementRecipientInfo>(() => _decode_KeyAgreementRecipientInfo) ],
    "CONTEXT 2": [ "keyEncryptionKeyRecipientInfo", __utils._decode_implicit<KeyEncryptionKeyRecipientInfo>(() => _decode_KeyEncryptionKeyRecipientInfo) ]
});
export const _encode_RecipientInfo = __utils._encode_choice<RecipientInfo>({
    ...
    "keyAgreementRecipientInfo": __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_KeyAgreementRecipientInfo, __utils.BER),
    "keyEncryptionKeyRecipientInfo": __utils._encode_implicit(asn1.ASN1TagClass.context, 2, () => _encode_KeyEncryptionKeyRecipientInfo, __utils.BER),
}, __utils.BER);
...
export const _decode_EncryptedContentInfo = function (el: asn1.ASN1Element): EncryptedContentInfo {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "encryptedContent": (_el: asn1.ASN1Element): void => { encryptedContent = __utils._decode_implicit<ENCRYPTED<asn1.ASN1Element>>(() => _get_decoder_for_ENCRYPTED<asn1.ASN1Element>(__utils._decodeAny))(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_EncryptedContentInfo = function (value: EncryptedContentInfo, elGetter: __utils.ASN1Encoder<EncryptedContentInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.encryptedContent === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _get_encoder_for_ENCRYPTED<asn1.ASN1Element>(__utils._encodeAny), __utils.BER)(value.encryptedContent, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_EnvelopedData: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("unprotectedAttributes", true, __utils.hasTag(asn1.ASN1TagClass.context, 1), undefined, undefined)
];
...
export const _decode_EnvelopedData = function (el: asn1.ASN1Element): EnvelopedData {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "unprotectedAttributes": (_el: asn1.ASN1Element): void => { unprotectedAttributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_EnvelopedData = function (value: EnvelopedData, elGetter: __utils.ASN1Encoder<EnvelopedData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.unprotectedAttributes === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_Attributes, __utils.BER)(value.unprotectedAttributes, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_SignedAndEnvelopedData = function (el: asn1.ASN1Element): SignedAndEnvelopedData {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    let version!: Version;
    ...
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_Version(_el); },
        "recipientInfos": (_el: asn1.ASN1Element): void => { recipientInfos = __utils._decodeSetOf<KeyTransportRecipientInfo>(() => _decode_KeyTransportRecipientInfo)(_el); },
        "digestAlgorithms": (_el: asn1.ASN1Element): void => { digestAlgorithms = _decode_DigestAlgorithmIdentifiers(_el); },
        "encryptedContentInfo": (_el: asn1.ASN1Element): void => { encryptedContentInfo = _decode_EncryptedContentInfo(_el); },
        "certificates": (_el: asn1.ASN1Element): void => { certificates = __utils._decode_implicit<CertificateSet>(() => _decode_CertificateSet)(_el); },
        "crls": (_el: asn1.ASN1Element): void => { crls = __utils._decode_implicit<CertificateRevocationLists>(() => _decode_CertificateRevocationLists)(_el); },
        "signerInfos": (_el: asn1.ASN1Element): void => { signerInfos = __utils._decodeSetOf<SignerInfo>(() => _decode_SignerInfo)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_SignedAndEnvelopedData = function (value: SignedAndEnvelopedData, elGetter: __utils.ASN1Encoder<SignedAndEnvelopedData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_Version(value.version, __utils.BER),
            /* REQUIRED   */ __utils._encodeSetOf<KeyTransportRecipientInfo>(() => _encode_KeyTransportRecipientInfo, __utils.BER)(value.recipientInfos, __utils.BER),
            /* REQUIRED   */ _encode_DigestAlgorithmIdentifiers(value.digestAlgorithms, __utils.BER),
            /* REQUIRED   */ _encode_EncryptedContentInfo(value.encryptedContentInfo, __utils.BER),
            /* IF_ABSENT  */ ((value.certificates === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_CertificateSet, __utils.BER)(value.certificates, __utils.BER)),
            /* IF_ABSENT  */ ((value.crls === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 1, () => _encode_CertificateRevocationLists, __utils.BER)(value.crls, __utils.BER)),
            /* REQUIRED   */ __utils._encodeSetOf<SignerInfo>(() => _encode_SignerInfo, __utils.BER)(value.signerInfos, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_DigestedData = function (el: asn1.ASN1Element): DigestedData {
    ...
    digest = _get_decoder_for_HASH<asn1.ASN1Element>(__utils._decodeAny)(sequence[3]);
    // TODO: Validate values.
...
export const _encode_DigestedData = function (value: DigestedData, elGetter: __utils.ASN1Encoder<DigestedData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_DigestAlgorithmIdentifier(value.digestAlgorithm, __utils.BER),
            /* REQUIRED   */ _encode_ContentInfo(value.contentInfo, __utils.BER),
            /* REQUIRED   */ _get_encoder_for_HASH<asn1.ASN1Element>(__utils._encodeAny)(value.digest, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_AuthenticatedData: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("messageAuthenticationCode", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
...
export const _decode_AuthenticatedData = function (el: asn1.ASN1Element): AuthenticatedData {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        "originatorInfo": (_el: asn1.ASN1Element): void => { originatorInfo = __utils._decode_implicit<OriginatorInfo>(() => _decode_OriginatorInfo)(_el); },
        "recipientInfos": (_el: asn1.ASN1Element): void => { recipientInfos = _decode_RecipientInfos(_el); },
        "macAlgorithm": (_el: asn1.ASN1Element): void => { macAlgorithm = _decode_MessageAuthenticationCodeAlgorithmIdentifier(_el); },
        ...
        "contentInfo": (_el: asn1.ASN1Element): void => { contentInfo = _decode_ContentInfo(_el); },
        "authenticatedAttributes": (_el: asn1.ASN1Element): void => { authenticatedAttributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(_el); },
        "messageAuthenticationCode": (_el: asn1.ASN1Element): void => { messageAuthenticationCode = _decode_MessageAuthenticationCode(_el); },
        "unauthenticatedAttributes": (_el: asn1.ASN1Element): void => { unauthenticatedAttributes = __utils._decode_implicit<Attributes>(() => _decode_Attributes)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_AuthenticatedData = function (value: AuthenticatedData, elGetter: __utils.ASN1Encoder<AuthenticatedData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.originatorInfo === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 0, () => _encode_OriginatorInfo, __utils.BER)(value.originatorInfo, __utils.BER)),
            /* REQUIRED   */ _encode_RecipientInfos(value.recipientInfos, __utils.BER),
            /* REQUIRED   */ _encode_MessageAuthenticationCodeAlgorithmIdentifier(value.macAlgorithm, __utils.BER),
            ...
            /* REQUIRED   */ _encode_ContentInfo(value.contentInfo, __utils.BER),
            /* IF_ABSENT  */ ((value.authenticatedAttributes === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 2, () => _encode_Attributes, __utils.BER)(value.authenticatedAttributes, __utils.BER)),
            /* REQUIRED   */ _encode_MessageAuthenticationCode(value.messageAuthenticationCode, __utils.BER),
            /* IF_ABSENT  */ ((value.unauthenticatedAttributes === undefined) ? undefined : __utils._encode_implicit(asn1.ASN1TagClass.context, 3, () => _encode_Attributes, __utils.BER)(value.unauthenticatedAttributes, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
