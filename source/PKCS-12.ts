...
export const _root_component_type_list_1_spec_for_MacData: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("macSalt", false, __utils.hasTag(asn1.ASN1TagClass.universal, 4), undefined, undefined),
    new __utils.ComponentSpec("iterations", true, __utils.hasTag(asn1.ASN1TagClass.universal, 2), undefined, undefined)
];
...
export const _decode_MacData = function (el: asn1.ASN1Element): MacData {
    ...
    const callbacks: __utils.DecodingMap = {
        "mac": (_el: asn1.ASN1Element): void => { mac = _decode_DigestInfo(_el); },
        "macSalt": (_el: asn1.ASN1Element): void => { macSalt = __utils._decodeOctetString(_el); },
        "iterations": (_el: asn1.ASN1Element): void => { iterations = __utils._decodeInteger(_el); }
    };
...
export const _encode_MacData = function (value: MacData, elGetter: __utils.ASN1Encoder<MacData>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_DigestInfo(value.mac, __utils.BER),
            /* REQUIRED   */ __utils._encodeOctetString(value.macSalt, __utils.BER),
            /* IF_DEFAULT */ (value.iterations === undefined || __utils.deepEq(value.iterations, _default_value_for_MacData__iterations) ? undefined : __utils._encodeInteger(value.iterations, __utils.BER))
        ],
...
export const _root_component_type_list_1_spec_for_PFX: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec("authSafe", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("macData", true, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined)
];
...
export const _decode_PFX = function (el: asn1.ASN1Element): PFX {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "version": (_el: asn1.ASN1Element): void => { version = _decode_PFX_version(_el); },
        "authSafe": (_el: asn1.ASN1Element): void => { authSafe = _decode_ContentInfo(_el); },
        "macData": (_el: asn1.ASN1Element): void => { macData = _decode_MacData(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_PFX = function (value: PFX, elGetter: __utils.ASN1Encoder<PFX>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_PFX_version(value.version, __utils.BER),
            /* REQUIRED   */ _encode_ContentInfo(value.authSafe, __utils.BER),
            /* IF_ABSENT  */ ((value.macData === undefined) ? undefined : _encode_MacData(value.macData, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_AuthenticatedSafe = __utils._decodeSequenceOf<ContentInfo>(() => _decode_ContentInfo);
export const _encode_AuthenticatedSafe = __utils._encodeSequenceOf<ContentInfo>(() => _encode_ContentInfo, __utils.BER);
...
export const _root_component_type_list_1_spec_for_PKCS12Attribute: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("attrId", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
...
export const _decode_PKCS12Attribute = function (el: asn1.ASN1Element): PKCS12Attribute {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("PKCS12Attribute contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    attrValues = __utils._decodeSetOf<asn1.ASN1Element>(() => __utils._decodeAny)(sequence[1]);
    // TODO: Validate values.
    return new PKCS12Attribute(
        attrId,
        attrValues,

    );
};
export const _encode_PKCS12Attribute = function (value: PKCS12Attribute, elGetter: __utils.ASN1Encoder<PKCS12Attribute>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeObjectIdentifier(value.attrId, __utils.BER),
            /* REQUIRED   */ __utils._encodeSetOf<asn1.ASN1Element>(() => __utils._encodeAny, __utils.BER)(value.attrValues, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_SafeBag: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("bagId", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
    new __utils.ComponentSpec("bagValue", false, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined),
    new __utils.ComponentSpec("bagAttributes", true, __utils.hasTag(asn1.ASN1TagClass.universal, 17), undefined, undefined)
];
...
export const _decode_SafeBag = function (el: asn1.ASN1Element): SafeBag {
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "bagId": (_el: asn1.ASN1Element): void => { bagId = __utils._decodeObjectIdentifier(_el); },
        "bagValue": (_el: asn1.ASN1Element): void => { bagValue = __utils._decode_explicit<asn1.ASN1Element>(() => __utils._decodeAny)(_el); },
        "bagAttributes": (_el: asn1.ASN1Element): void => { bagAttributes = __utils._decodeSetOf<PKCS12Attribute>(() => _decode_PKCS12Attribute)(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export const _encode_SafeBag = function (value: SafeBag, elGetter: __utils.ASN1Encoder<SafeBag>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeObjectIdentifier(value.bagId, __utils.BER),
            /* REQUIRED   */ __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeAny, __utils.BER)(value.bagValue, __utils.BER),
            /* IF_ABSENT  */ ((value.bagAttributes === undefined) ? undefined : __utils._encodeSetOf<PKCS12Attribute>(() => _encode_PKCS12Attribute, __utils.BER)(value.bagAttributes, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _decode_SafeContents = __utils._decodeSequenceOf<SafeBag>(() => _decode_SafeBag);
export const _encode_SafeContents = __utils._encodeSequenceOf<SafeBag>(() => _encode_SafeBag, __utils.BER);
...
export const _root_component_type_list_1_spec_for_CertBag: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("certId", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
    new __utils.ComponentSpec("certValue", false, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined)
];
...
export const _decode_CertBag = function (el: asn1.ASN1Element): CertBag {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CertBag contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    certValue = __utils._decode_explicit<asn1.ASN1Element>(() => __utils._decodeAny)(sequence[1]);
    // TODO: Validate values.
    return new CertBag(
        certId,
        certValue,
...
export const _encode_CertBag = function (value: CertBag, elGetter: __utils.ASN1Encoder<CertBag>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeObjectIdentifier(value.certId, __utils.BER),
            /* REQUIRED   */ __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeAny, __utils.BER)(value.certValue, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_CRLBag: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("crlId", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
    new __utils.ComponentSpec("crltValue", false, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined)
];
...
export const _decode_CRLBag = function (el: asn1.ASN1Element): CRLBag {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("CRLBag contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    crltValue = __utils._decode_explicit<asn1.ASN1Element>(() => __utils._decodeAny)(sequence[1]);
    // TODO: Validate values.
    return new CRLBag(
        crlId,
        crltValue,
...
export const _encode_CRLBag = function (value: CRLBag, elGetter: __utils.ASN1Encoder<CRLBag>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeObjectIdentifier(value.crlId, __utils.BER),
            /* REQUIRED   */ __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeAny, __utils.BER)(value.crltValue, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
...
export const _root_component_type_list_1_spec_for_SecretBag: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("secretTypeId", false, __utils.hasTag(asn1.ASN1TagClass.universal, 6), undefined, undefined),
    new __utils.ComponentSpec("secretValue", false, __utils.hasTag(asn1.ASN1TagClass.context, 0), undefined, undefined)
];
...
export const _decode_SecretBag = function (el: asn1.ASN1Element): SecretBag {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new asn1.ASN1ConstructionError("SecretBag contained only " + sequence.length.toString() + " elements.");
    }
    // TODO: Validate tags.
    ...
    secretValue = __utils._decode_explicit<asn1.ASN1Element>(() => __utils._decodeAny)(sequence[1]);
    // TODO: Validate values.
    return new SecretBag(
        secretTypeId,
        secretValue,

    );
};
export const _encode_SecretBag = function (value: SecretBag, elGetter: __utils.ASN1Encoder<SecretBag>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ __utils._encodeObjectIdentifier(value.secretTypeId, __utils.BER),
            /* REQUIRED   */ __utils._encode_explicit(asn1.ASN1TagClass.context, 0, () => __utils._encodeAny, __utils.BER)(value.secretValue, __utils.BER)
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
};
