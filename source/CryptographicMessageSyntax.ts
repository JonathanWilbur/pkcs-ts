...
export const _decode_EncapsulatedContentInfo = function (
    el: asn1.ASN1Element
...
export const _encode_EncapsulatedContentInfo = function (
...
export const _decode_UnauthAttributes = __utils._decodeSetOf<Attribute>(
    () => _decode_Attribute
);
export const _encode_UnauthAttributes = __utils._encodeSetOf<Attribute>(
    () => _encode_Attribute,
    __utils.BER
);
...
export const _decode_ExtendedCertificate = function (
    el: asn1.ASN1Element
): ExtendedCertificate {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 3) {
...
export const _encode_ExtendedCertificate = function (
...
export const _decode_CertificateChoices = __utils._decode_inextensible_choice<
    CertificateChoices
>({
...
export const _encode_CertificateChoices = __utils._encode_choice<
    CertificateChoices
>(
    {
...
export const _decode_CertificateSet = __utils._decodeSetOf<CertificateChoices>(
    () => _decode_CertificateChoices
);
export const _encode_CertificateSet = __utils._encodeSetOf<CertificateChoices>(
...
export const _decode_UnsignedAttributes = __utils._decodeSetOf<Attribute>(
    () => _decode_Attribute
);
export const _encode_UnsignedAttributes = __utils._encodeSetOf<Attribute>(
    () => _encode_Attribute,
    __utils.BER
);
...
export const _decode_SignerInfo = function (el: asn1.ASN1Element): SignerInfo {
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        unsignedAttrs: (_el: asn1.ASN1Element): void => {
            unsignedAttrs = __utils._decode_implicit<UnsignedAttributes>(
...
export const _decode_OriginatorInfo = function (
    ...
    return new OriginatorInfo /* SEQUENCE_CONSTRUCTOR_CALL */(certs, crls);
};
...
export const _decode_KeyTransRecipientInfo = function (
    el: asn1.ASN1Element
...
export const _encode_KeyTransRecipientInfo = function (
        ...
        ([] as (asn1.ASN1Element | undefined)[])
            .concat([
                ...
                /* IF_ABSENT  */ value.other === undefined
                    ? undefined
                    : _encode_OtherKeyAttribute(value.other, __utils.BER),
            ])
            .filter(
                (c: asn1.ASN1Element | undefined): boolean => !!c
            ) as asn1.ASN1Element[],
...
export const _decode_KeyAgreeRecipientIdentifier = __utils._decode_inextensible_choice<
...
export const _encode_KeyAgreeRecipientIdentifier = __utils._encode_choice<
    KeyAgreeRecipientIdentifier
>(
    {
        issuerAndSerialNumber: _encode_IssuerAndSerialNumber,
...
export const _decode_KeyAgreeRecipientInfo = function (
    el: asn1.ASN1Element
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        originator: (_el: asn1.ASN1Element): void => {
            originator = __utils._decode_explicit<OriginatorIdentifierOrKey>(
...
export const _encode_KeyAgreeRecipientInfo = function (
...
export const _decode_KEKIdentifier = function (
    el: asn1.ASN1Element
): KEKIdentifier {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
...
export const _encode_KEKIdentifier = function (
    value: KEKIdentifier,
...
export const _decode_KEKRecipientInfo = function (
    el: asn1.ASN1Element
): KEKRecipientInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 4) {
...
export const _encode_KEKRecipientInfo = function (
...
export const _decode_EncryptedContentInfo = function (
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        encryptedContent: (_el: asn1.ASN1Element): void => {
            encryptedContent = __utils._decode_implicit<EncryptedContent>(
...
export const _decode_UnprotectedAttributes = __utils._decodeSetOf<Attribute>(
    () => _decode_Attribute
);
export const _encode_UnprotectedAttributes = __utils._encodeSetOf<Attribute>(
    () => _encode_Attribute,
    __utils.BER
);
...
export const _decode_EnvelopedData = function (
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        unprotectedAttrs: (_el: asn1.ASN1Element): void => {
            unprotectedAttrs = __utils._decode_implicit<UnprotectedAttributes>(
...
export const _decode_AuthAttributes = __utils._decodeSetOf<Attribute>(
    () => _decode_Attribute
);
export const _encode_AuthAttributes = __utils._encodeSetOf<Attribute>(
    () => _encode_Attribute,
    __utils.BER
);
...
export const _decode_AuthenticatedData = function (
    ...
    const callbacks: __utils.DecodingMap = {
        ...
        authenticatedAttributes: (_el: asn1.ASN1Element): void => {
            authenticatedAttributes = __utils._decode_implicit<AuthAttributes>(
...
export const _decode_RC2CBCParameter = function (
    el: asn1.ASN1Element
): RC2CBCParameter {
    const sequence: asn1.ASN1Element[] = el.sequence;
    if (sequence.length < 2) {
...
export const _encode_RC2CBCParameter = function (
