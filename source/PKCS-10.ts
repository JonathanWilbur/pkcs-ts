...
export const _decode_CertificationRequestInfo = function (el: asn1.ASN1Element): CertificationRequestInfo {
    const sequence: asn1.ASN1Element[] = el.sequence;
...
export const _encode_CertificationRequestInfo = function (value: CertificationRequestInfo, elGetter: __utils.ASN1Encoder<CertificationRequestInfo>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
...
export const _decode_CertificationRequest = function (el: asn1.ASN1Element): CertificationRequest {
    const sequence: asn1.ASN1Element[] = el.sequence;
...
export const _encode_CertificationRequest = function (value: CertificationRequest, elGetter: __utils.ASN1Encoder<CertificationRequest>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
